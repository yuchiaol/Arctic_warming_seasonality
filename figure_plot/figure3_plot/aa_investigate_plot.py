...
#   plt.plot(tt,ts_test,'-',color='blue',label='co2x0.25')
...
#   plt.plot(tt,ts_test,'-',color='blueviolet',label='co2x0.5')
...
#   plt.plot(tt,ts_test,'-',color='rosybrown',label='co2x1')
   ...
   plt.legend(ncol=7, loc='upper right')
   plt.title('(a) Arctic Amplificaton Factor (AAF)')
   plt.xlim(1,150)
   plt.ylim(1.5,3.5)
...
# AAF plot
   ...
   ttt = np.array([0.25, 0.5, 2, 3, 4, 5, 6, 7, 8])
   ...
   for II in range(7):
       ...
       plt.plot([ttt[II+2]-0.19,ttt[II+2]+0.19],[ts_interval[II+2,0]]*2,'k-')
       plt.plot([ttt[II+2]-0.19,ttt[II+2]+0.19],[ts_interval[II+2,1]]*2,'k-')

   plt.plot(ttt[2:],[aa_co2x2.mean(),aa_co2x3.mean(),aa_co2x4.mean(),\
   ...
   for II in range(5):
       ...
       plt.plot([ttt[II+2]-0.19,ttt[II+2]+0.19],[ts_interval[II,0]]*2,'k-')
       plt.plot([ttt[II+2]-0.19,ttt[II+2]+0.19],[ts_interval[II,1]]*2,'k-')

   plt.plot(ttt[2:7],[aa_e_co2x2.mean(),aa_e_co2x3.mean(),aa_e_co2x4.mean(),aa_e_co2x5.mean(),aa_e_co2x6.mean()], 'k^--', label='slab ocean model', markersize=9)
...
# seasonal cycle evolution
   ...
   plt.title('(c) AAF Seasonal Amplitude')
