...
#   plt.plot(tt,np.nanmean(ts_test_xp5[-30:,:], axis=0),'o-',color='blueviolet',label='x0.5', alpha=0.3)
   ...
   plt.ylim(-0.75,0.25)
   plt.title('(a) FOM Outside Arctic SAT Response')
   plt.ylabel('K')
   ...
   plt.plot(tt,np.nanmean(ts_test_x2[-30:,:], axis=0)-np.nanmean(ts_test_x2[-30:,:], axis=0)[0],'^-',color='b',label='2x')
   plt.plot(tt,np.nanmean(ts_test_x3[-30:,:], axis=0)-np.nanmean(ts_test_x3[-30:,:], axis=0)[0],'^-',color='dodgerblue',label='3x')
   plt.plot(tt,np.nanmean(ts_test_x4[-30:,:], axis=0)-np.nanmean(ts_test_x4[-30:,:], axis=0)[0],'^-',color='springgreen',label='4x')
   plt.plot(tt,np.nanmean(ts_test_x5[-30:,:], axis=0)-np.nanmean(ts_test_x5[-30:,:], axis=0)[0],'^-',color='gold',label='5x')
   plt.plot(tt,np.nanmean(ts_test_x6[-30:,:], axis=0)-np.nanmean(ts_test_x6[-30:,:], axis=0)[0],'^-',color='orange',label='6x')
   plt.xticks(tt,['Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun'], fontsize=10)
   plt.legend(ncol=1,fontsize='small',loc='lower left')
   plt.ylim(-0.75,0.25)
   plt.title('(c) SOM Outside Arctic SAT Response')
   plt.ylabel('K')
...
#   plt.plot(tt,np.nanmean(ts_test_xp5[-30:,:], axis=0)-np.nanmean(ts_test_xp5[-30:,:], axis=0)[0],'o-',color='blueviolet',label='x0.5', alpha=0.3)
   ...
   plt.ylim(-0.4,1)
   plt.title('(b) FOM Global SAT Response')
   plt.ylabel('K')
...
# SOM case
   ...
   plt.plot(tt,np.nanmean(tse_test_x2[-30:,:], axis=0)-np.nanmean(tse_test_x2[-30:,:], axis=0)[0],'^-',color='b',label='2x')
   plt.plot(tt,np.nanmean(tse_test_x3[-30:,:], axis=0)-np.nanmean(tse_test_x3[-30:,:], axis=0)[0],'^-',color='dodgerblue',label='3x')
   plt.plot(tt,np.nanmean(tse_test_x4[-30:,:], axis=0)-np.nanmean(tse_test_x4[-30:,:], axis=0)[0],'^-',color='springgreen',label='4x')
   plt.plot(tt,np.nanmean(tse_test_x5[-30:,:], axis=0)-np.nanmean(tse_test_x5[-30:,:], axis=0)[0],'^-',color='gold',label='5x')
   plt.plot(tt,np.nanmean(tse_test_x6[-30:,:], axis=0)-np.nanmean(tse_test_x6[-30:,:], axis=0)[0],'^-',color='orange',label='6x')
   plt.xticks(tt,['Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun'], fontsize=10)
   plt.legend(ncol=1,fontsize='small',loc='upper left')
   plt.ylim(-0.4,1)
