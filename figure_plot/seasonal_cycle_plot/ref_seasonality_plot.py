...
#   plt.plot(tt,np.nanmean(ts_test_xp5[-30:,:], axis=0),'o-',color='blueviolet',label='x0.5', alpha=0.3)
   plt.plot(tt,np.nanmean(ts_test_x2[-30:,:], axis=0)-np.nanmean(ts_test_x2[-30:,:], axis=0)[0],'o-',color='b',label='x2')
   plt.plot(tt,np.nanmean(ts_test_x3[-30:,:], axis=0)-np.nanmean(ts_test_x3[-30:,:], axis=0)[0],'o-',color='dodgerblue',label='x3')
   plt.plot(tt,np.nanmean(ts_test_x4[-30:,:], axis=0)-np.nanmean(ts_test_x4[-30:,:], axis=0)[0],'o-',color='springgreen',label='x4')
   plt.plot(tt,np.nanmean(ts_test_x5[-30:,:], axis=0)-np.nanmean(ts_test_x5[-30:,:], axis=0)[0],'o-',color='gold',label='x5')
   plt.plot(tt,np.nanmean(ts_test_x6[-30:,:], axis=0)-np.nanmean(ts_test_x6[-30:,:], axis=0)[0],'o-',color='orange',label='x6')
   plt.plot(tt,np.nanmean(ts_test_x7[-30:,:], axis=0)-np.nanmean(ts_test_x7[-30:,:], axis=0)[0],'o-',color='tomato',label='x7')
   plt.plot(tt,np.nanmean(ts_test_x8[-30:,:], axis=0)-np.nanmean(ts_test_x8[-30:,:], axis=0)[0],'o-',color='red',label='x8')
   plt.xticks(tt,['Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun'], fontsize=10)
   plt.legend(ncol=1,fontsize='small',loc='upper left')
   plt.ylim(-1,13)
   plt.title('(a) FOM Arctic SAT Response')
   plt.ylabel('K')
   ...
   plt.plot(tt,np.nanmean(ts_test_x2[-30:,:], axis=0)-np.nanmean(ts_test_x2[-30:,:], axis=0)[0],'^-',color='b',label='x2')
   plt.plot(tt,np.nanmean(ts_test_x3[-30:,:], axis=0)-np.nanmean(ts_test_x3[-30:,:], axis=0)[0],'^-',color='dodgerblue',label='x3')
   plt.plot(tt,np.nanmean(ts_test_x4[-30:,:], axis=0)-np.nanmean(ts_test_x4[-30:,:], axis=0)[0],'^-',color='springgreen',label='x4')
   plt.plot(tt,np.nanmean(ts_test_x5[-30:,:], axis=0)-np.nanmean(ts_test_x5[-30:,:], axis=0)[0],'^-',color='gold',label='x5')
   plt.plot(tt,np.nanmean(ts_test_x6[-30:,:], axis=0)-np.nanmean(ts_test_x6[-30:,:], axis=0)[0],'^-',color='orange',label='x6')
   plt.xticks(tt,['Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun'], fontsize=10)
   plt.legend(ncol=1,fontsize='small',loc='upper left')
   plt.ylim(-1,13)
   plt.title('(b) SOM Arctic SAT Response')
   plt.ylabel('K')
...
# SOM case
   ts_interval = np.zeros((5,2,12))
   for III in range(12):
       ts_test = tse_test_x2[-30:,III].copy()-tse_test_x2[-30:,0].mean()
       ts_interval[0,:,III] = stats.t.interval(0.95, len(ts_test) - 1, loc=ts_test.mean(), scale= np.std(ts_test) / np.sqrt(len(ts_test)))
       ts_test = tse_test_x3[-30:,III].copy()-tse_test_x3[-30:,0].mean()
       ts_interval[1,:,III] = stats.t.interval(0.95, len(ts_test) - 1, loc=ts_test.mean(), scale= np.std(ts_test) / np.sqrt(len(ts_test)))
       ts_test = tse_test_x4[-30:,III].copy()-tse_test_x4[-30:,0].mean()
       ts_interval[2,:,III] = stats.t.interval(0.95, len(ts_test) - 1, loc=ts_test.mean(), scale= np.std(ts_test) / np.sqrt(len(ts_test)))
       ts_test = tse_test_x5[-30:,III].copy()-tse_test_x5[-30:,0].mean()
       ts_interval[3,:,III] = stats.t.interval(0.95, len(ts_test) - 1, loc=ts_test.mean(), scale= np.std(ts_test) / np.sqrt(len(ts_test)))
       ts_test = tse_test_x6[-30:,III].copy()-tse_test_x6[-30:,0].mean()
       ts_interval[4,:,III] = stats.t.interval(0.95, len(ts_test) - 1, loc=ts_test.mean(), scale= np.std(ts_test) / np.sqrt(len(ts_test)))
   ...
   plt.plot(tt,np.nanmean(tse_test_x2[-30:,:], axis=0)-np.nanmean(tse_test_x2[-30:,:], axis=0)[0],'^-',color='b',label='x2')
   plt.plot(tt,np.nanmean(tse_test_x3[-30:,:], axis=0)-np.nanmean(tse_test_x3[-30:,:], axis=0)[0],'^-',color='dodgerblue',label='x3')
   plt.plot(tt,np.nanmean(tse_test_x4[-30:,:], axis=0)-np.nanmean(tse_test_x4[-30:,:], axis=0)[0],'^-',color='springgreen',label='x4')
   plt.plot(tt,np.nanmean(tse_test_x5[-30:,:], axis=0)-np.nanmean(tse_test_x5[-30:,:], axis=0)[0],'^-',color='gold',label='x5')
   plt.plot(tt,np.nanmean(tse_test_x6[-30:,:], axis=0)-np.nanmean(tse_test_x6[-30:,:], axis=0)[0],'^-',color='orange',label='x6')
   plt.xticks(tt,['Jul','Aug','Sep','Oct','Nov','Dec','Jan','Feb','Mar','Apr','May','Jun'], fontsize=10)
   plt.legend(ncol=1,fontsize='small',loc='upper left')
   plt.ylim(-0.4,1)
   plt.title('(d) SOM Global SAT Response')
