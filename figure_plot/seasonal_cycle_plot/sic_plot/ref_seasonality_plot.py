...
# read grid basics
   ...
   for NM in range(12):
       ...
       print(filename)
       f = Dataset(dirname + filename, 'r')
       esat2_co2x1[:,NM,:,:] = f.variables['var_co2x1'][-30:,:,:].data
       esat2_co2x2[:,NM,:,:] = f.variables['var_co2x2'][-30:,:,:].data
       esat2_co2x3[:,NM,:,:] = f.variables['var_co2x3'][-30:,:,:].data
       esat2_co2x4[:,NM,:,:] = f.variables['var_co2x4'][-30:,:,:].data
       esat2_co2x5[:,NM,:,:] = f.variables['var_co2x5'][-30:,:,:].data
       esat2_co2x6[:,NM,:,:] = f.variables['var_co2x6'][-30:,:,:].data
       f.close()
...
#   plt.ylim(-1,13)
   plt.title('(a) FOM Arctic SIE Response')
...
#   plt.ylim(-1,13)
   plt.title('(c) SOM Arctic SIE Response')
   plt.ylabel('km$^2$ x 10$^6$')
...
#   plt.ylim(-5,35)
   plt.ylabel('W/m$^2$')
   plt.title('(b) FOM Turbulent Heat Flux Response')
...
#   plt.ylim(-5,35)
   plt.ylabel('W/m$^2$')
   plt.title('(d) SOM Turbulent Heat Flux Response')
