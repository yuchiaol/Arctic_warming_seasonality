...
#   plt.plot([9]*2,[(ts_max_x8-ts_min_x8)[-30:].mean()]*2,'o',color='r',markersize=9)
   plt.plot(ttt[2:9],test_array,'o-',color='r',label='FOM',markersize=9)
...
#   plt.plot([7]*2,[(tse_max_x6-tse_min_x6)[-30:].mean()]*2,'^',color='c',markersize=9)
   ...
   plt.plot(ttt[2:7],test_array,'^-',color='b',label='SOM',markersize=9)

   plt.legend()

   plt.xticks(np.linspace(1,9,9),['co2x0.25','co2x0.5','CO2x2','CO2x3','CO2x4','CO2x5','CO2x6','CO2x7','CO2x8'], rotation=0)
