...
# read grid basics
   ...
   for NM in range(12):
       dirname = '/data1/yliang/co2_experiments/processed_data/'
       filename1 = 'PRECL_month' + str(NM+1) + '_mean_temp_output.nc'
       print(filename1)
       f1 = Dataset(dirname + filename1, 'r')
       filename2 = 'PRECC_month' + str(NM+1) + '_mean_temp_output.nc'
       print(filename2)
       f2 = Dataset(dirname + filename2, 'r')
       sat_control[:,NM,:,:] = f1.variables['var_co2x1'][:,:,:].data*factor_p + f2.variables['var_co2x1'][:,:,:].data*factor_p
       sat_co2xp25[:,NM,:,:] = f1.variables['var_co2xp25'][:,:,:].data*factor_p + f2.variables['var_co2xp25'][:,:,:].data*factor_p
       sat_co2xp5[:,NM,:,:] = f1.variables['var_co2xp5'][:,:,:].data*factor_p + f2.variables['var_co2xp5'][:,:,:].data*factor_p
       sat_co2x1[:,NM,:,:] = f1.variables['var_co2x1'][:,:,:].data*factor_p + f2.variables['var_co2x1'][:,:,:].data*factor_p
       sat_co2x2[:,NM,:,:] = f1.variables['var_co2x2'][:,:,:].data*factor_p + f2.variables['var_co2x2'][:,:,:].data*factor_p
       sat_co2x3[:,NM,:,:] = f1.variables['var_co2x3'][:,:,:].data*factor_p + f2.variables['var_co2x3'][:,:,:].data*factor_p
       sat_co2x4[:,NM,:,:] = f1.variables['var_co2x4'][:,:,:].data*factor_p + f2.variables['var_co2x4'][:,:,:].data*factor_p
       sat_co2x5[:,NM,:,:] = f1.variables['var_co2x5'][:,:,:].data*factor_p + f2.variables['var_co2x5'][:,:,:].data*factor_p
       sat_co2x6[:,NM,:,:] = f1.variables['var_co2x6'][:,:,:].data*factor_p + f2.variables['var_co2x6'][:,:,:].data*factor_p
       sat_co2x7[:,NM,:,:] = f1.variables['var_co2x7'][:,:,:].data*factor_p + f2.variables['var_co2x7'][:,:,:].data*factor_p
       sat_co2x8[:,NM,:,:] = f1.variables['var_co2x8'][:,:,:].data*factor_p + f2.variables['var_co2x8'][:,:,:].data*factor_p
       f1.close()
       f2.close() 

# select arctic region
   [x1, x2, y1, y2] = data_process_f.find_lon_lat_index(0,360,60,89,lon,lat)
   [x11, x22, y11, y22] = data_process_f.find_lon_lat_index(50,90,60,72,lon,lat)
...
# simulated sat
   ...
   for NT in range(year_N):
       for NM in range(12):
           print(NT, NM)
           ts_sat_control_global[NT,NM] = np.nansum(sat_control[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2xp25_global[NT,NM] = np.nansum(sat_co2xp25[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2xp5_global[NT,NM] = np.nansum(sat_co2xp5[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x1_global[NT,NM] = np.nansum(sat_co2x1[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x2_global[NT,NM] = np.nansum(sat_co2x2[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x3_global[NT,NM] = np.nansum(sat_co2x3[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x4_global[NT,NM] = np.nansum(sat_co2x4[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x5_global[NT,NM] = np.nansum(sat_co2x5[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x6_global[NT,NM] = np.nansum(sat_co2x6[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x7_global[NT,NM] = np.nansum(sat_co2x7[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
           ts_sat_co2x8_global[NT,NM] = np.nansum(sat_co2x8[NT,NM,y11:y22+1,x11:x22+1]*area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])/np.nansum(area[y11:y22+1,x11:x22+1]*mask_var[y11:y22+1,x11:x22+1])
...
#   plt.ylim(-1,13)
   plt.title('(a) Arctic Precipitation Response')
   plt.ylabel('mm/day')

# East Siberian precipitation
...
#   ax1 = fig.add_axes([0.1, 0.37, 0.36, 0.27])
   ...
   plt.legend(ncol=1,fontsize='small',loc='upper left')
#   plt.ylim(-0.4,0.6)
   plt.title('(b) Eurasian Precipitation Response')
   plt.ylabel('mm/day')
