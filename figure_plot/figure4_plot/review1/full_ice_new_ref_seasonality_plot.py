...
# no ice
   ...
   mask_control[mask_control>=0.15*factor0] = 1.
   mask_co2x1[mask_co2x1>=0.15*factor0] = 1.
   mask_co2x2[mask_co2x2>=0.15*factor0] = 1.
   mask_co2x3[mask_co2x3>=0.15*factor0] = 1.
   mask_co2x4[mask_co2x4>=0.15*factor0] = 1.
   mask_co2x5[mask_co2x5>=0.15*factor0] = 1.
   mask_co2x6[mask_co2x6>=0.15*factor0] = 1.
   mask_co2x7[mask_co2x7>=0.15*factor0] = 1.
   mask_co2x8[mask_co2x8>=0.15*factor0] = 1.
...
#   plt.ylim(-1,13)
   plt.title('(a) Ice-covered Arctic SAT Response')
   plt.ylabel('K')
...
#   plt.ylim(-5,35)
   plt.ylabel('W/m$^2$')
   plt.title('(c) Ice-covered Turbulent Heat Flux Response')
