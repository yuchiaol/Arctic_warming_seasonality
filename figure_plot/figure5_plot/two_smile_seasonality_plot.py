...
# plot Arctic warming
   ...
   plot_here(tt,dtas_arctic_hist_month3,'','2011-2040','g')
   ...
   plt.title('(a) CanESM2 Arctic SAT (50)', fontsize=10)
...
# plot AAF
   ...
   plt.title('(b) CanESM2 AAF (50)', fontsize=10)
   ...
   plt.ylabel('K')
   plt.legend(loc='upper left',fontsize='small')
   plt.title('(c) MPI-ESM Arctic SAT (100)', fontsize=10)
...
#   plt.ylim(0,6)
   ...
   plt.xlim(1,12)
   plt.legend(loc='upper right',fontsize='small')
   plt.title('(d) MPI-ESM AAF (100)', fontsize=10)
